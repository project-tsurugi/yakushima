...
public:
  ...
  bool operator==(const node_version64_body &rhs) const {
    return get_locked() == rhs.get_locked() &&
           ...
           get_splitting() == rhs.get_splitting() && get_deleted() == rhs.get_deleted() &&
           get_root() == rhs.get_root() && get_border() == rhs.get_border() &&
  ...
  bool operator!=(const node_version64_body &rhs) const { return !(*this == rhs); }
  ...
  [[nodiscard]] bool get_inserting_deleting() const { return inserting_deleting; }
  ...
  [[nodiscard]] vinsert_delete_type get_vinsert_delete() const { return vinsert_delete; }
